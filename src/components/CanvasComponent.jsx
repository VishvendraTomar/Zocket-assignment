...
class CanvasEditor {
  ...
  drawDesignPattern(imageSrc) {
    ...
    image.src = imageSrc
    image.onload = () => {
      this.context.drawImage(image, 10, 0, this.canvas.width, this.canvas.height)
    }
  }
  ...
  drawdefaultImage(maskdefaultImage, x, y, width, height) {
    const image = new Image()
    image.src = maskdefaultImage
    image.onload = () => {
      this.context.drawImage(image, x, y, width, height)
    }
  }
...
const CanvasComponent = () => {
  ...
  return (
    <div className="relative flex gap-40 w-3/5 justify-center ">
      ...
      <div className="flex flex-col gap-10 w-full justify-center">
        ...
        <div>
          <div className="text-xs text-left">Ad Content</div>
          <input
        ...
        <div>
          <div className="text-xs text-left">CTA</div>
          <input
            className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg block w-full p-2.5"
            type="text"
